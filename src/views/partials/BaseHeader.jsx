...
function BaseHeader() {
    ...
    const [isLoggedIn, isCliente, isTransportista] = useAuthStore((state) => [state.isLoggedIn, state.isCliente, state.isTransportista]);
                ...
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="https://fleteseguro.com.mx/" target="_blank" rel="noopener noreferrer">
                                <i className="fas fa-address-card"></i> Nosotros
                            </a>
                        </li>
                        ...
                        <li className="nav-item dropdown">
                            <a
                                ...
                                aria-expanded="false"
                            >
                                <i className="fas fa-graduation-cap"></i> Clientes
                            </a>
                        ...
                        {isLoggedIn() === true && isTransportista() === true ? (
                        <li className="nav-item dropdown">
                        <a
                            className="nav-link dropdown-toggle"
                            href="#"
                            ...
                            aria-expanded="false"
                        >
                            <i className="fas fa-chalkboard-user"></i> Transportistas
                        </a>
                        <ul className="dropdown-menu">
                            <li>
                                <Link
