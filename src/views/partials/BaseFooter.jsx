        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-12">
            ...
            <div className="mb-4">
              ...
              <p>CDMX
              C. Gabriel Mancera 725, Col del Valle Centro, Benito Juárez, 03100 Ciudad de México</p>
              <p className="mb-1">
                Email:
                <a href="#" className='text-white'>contacto@fleteseguro.com.mx</a>
              </p>
              <p>
                Phone: +52 55 56392735
                <span className="text-dark fw-semibold">+52 55 56392735</span>
              </p>
            </div>
          </div>
        </div>
